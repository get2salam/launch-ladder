  ...
  "slug": "launch-ladder",
  "title": "Launch Ladder",
  "tagline": "Climb from idea to release with visible launch steps and blockers.",
  "domainLabel": "steps",
  "itemLabel": "step",
  "emptyTitle": "No launch steps yet",
  "emptyBody": "Add the steps that carry this launch from fragile to ready.",
  "seedTitle": "Micro-product launch ladder",
  "seedSubtitle": "A release board for solo builders who want clarity without bloat.",
  "categories": [
    "Idea",
    "Build",
    "Proof",
  ...
  "items": [
    {
      ...
      "score": 10,
      "effort": 1,
      "note": "The landing page should be able to say the whole promise in one breath."
    },
    {
      "title": "Record a tiny walkthrough",
      "category": "Proof",
      "state": "Moving",
      "score": 8,
      "effort": 3,
      "note": "People trust motion and specificity more than polished adjectives."
    },
    {
      "title": "Prep launch DM list",
      "category": "Release",
      "state": "Pending",
      "score": 9,
      "effort": 2,
      "note": "A hand-picked outreach list beats spraying a generic announcement."
    }
  ]
};
