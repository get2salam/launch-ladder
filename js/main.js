const SPEC = {
  "slug": "launch-ladder",
  "title": "Launch Ladder",
  "description": "Climb from idea to release with visible launch steps and blockers.",
  "lede": "Turn launches into a clearer sequence of owners, blockers, readiness signals, and target dates.",
  "heroEyebrow": "Launch planning workspace",
  "boardTitle": "Launch ladder board",
  "boardSubtitle": "A local-first board for moving from idea to release without losing track of the blockers.",
  "accent": "Keep each launch step visible so readiness rises while blockers and friction get handled before release week gets messy.",
  "itemLabel": "launch step",
  "itemPluralLabel": "Launch steps",
  "labels": {
    "title": "Launch step",
    "note": "Launch note",
    "category": "Step type",
  ...
  "textOne": {
    "label": "Owner",
    "default": "Who owns this step"
  },
  "textTwo": {
    "label": "Blocker",
    "default": "What is slowing this down"
  },
  "date": {
    "label": "Launch date"
  },
  ...
  "defaults": {
    "note": "Capture what makes this step critical to a clean launch, not just a box to tick."
  },
  "stats": {
    "totalLabel": "Steps",
    "motionLabel": "In motion",
    "dueLabel": "Near release"
  },
  "insights": {
    "topLabel": "Highest leverage step",
    "dateLabel": "Next launch milestone",
    "metricLabel": "Most ready"
  },
  "queue": {
    "eyebrow": "Launch queue",
    "title": "What needs movement next",
    "empty": "Released steps leave the active launch queue."
  },
  "mix": {
    "eyebrow": "Launch mix",
    "title": "Where the launch work is concentrated"
  },
  "emptyTitle": "No launch steps yet",
  "emptyBody": "Add the launch steps, blockers, and owners that turn a vague release into a real plan.",
  "actions": [
    {
      "id": "schedule-launch",
      ...
      "days": 3,
      "fromToday": true,
      "toast": "Scheduled the next launch milestone."
    },
    {
      "id": "clear-blocker",
      "label": "Clear blocker",
      ...
      "effortDelta": -1,
      "metricDelta": 1,
      "toast": "Reduced friction on this launch step."
    },
    {
      "id": "release",
      "label": "Mark released",
      ...
      "days": 0,
      "fromToday": true,
      "toast": "Marked this launch step released."
    }
  ],
  "theme": {
    "primary": "#38bdf8",
  ...
  "items": [
    {
      "title": "Narrative lock for homepage",
      "category": "Idea",
      "state": "Building",
      "score": 9,
      "effort": 4,
      "metric": 7,
      "textOne": "Founder",
      "textTwo": "Headline still too vague",
      "date": "2026-04-27",
      "note": "The homepage needs one clear promise before the rest of the launch assets can line up."
    },
    {
      ...
      "metric": 8,
      "textOne": "Ops",
      "textTwo": "Final browser pass",
      "date": "2026-04-25",
      "note": "A visible walkthrough lowers surprise on launch day."
    },
    {
      ...
      "metric": 5,
      "textOne": "Support",
      "textTwo": "Choose collection channel",
      "date": "2026-04-30",
      "note": "The launch is cleaner when feedback capture is planned before release."
    }
  ]
};
